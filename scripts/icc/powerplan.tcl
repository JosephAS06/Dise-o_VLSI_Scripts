...
# REJILLA DE VDD/VSS
##########################################################################################
create_pg_mesh_pattern P_top_two -layers { { {horizontal_layer: M7} {width: 0.6} {spacing: interleaving} {pitch: 30} {offset: 0.856} {trim : true} } { {vertical_layer: M6}   {width: 0.6} {spacing: interleaving} {pitch: 30} {offset: 6.08}  {trim : true} } } 
...
set_virtual_pad -net VSS -coordinate {162.5 -5} -layer M6
set_virtual_pad -net VDD -coordinate {325 -5} -layer M6
set_virtual_pad -net VSS -coordinate {485 -5} -layer M6
set_virtual_pad -net VSS -coordinate {-5 174} -layer M6
set_virtual_pad -net VDD -coordinate {-5 350} -layer M6
set_virtual_pad -net VSS -coordinate {-5 525} -layer M6
set_virtual_pad -net VDD -coordinate {485 174} -layer M6
set_virtual_pad -net VSS -coordinate {485 350} -layer M6
set_virtual_pad -net VDD -coordinate {485 525} -layer M6
set_virtual_pad -net VDD -coordinate {162.5 525} -layer M6
set_virtual_pad -net VSS -coordinate {325 525} -layer M6
