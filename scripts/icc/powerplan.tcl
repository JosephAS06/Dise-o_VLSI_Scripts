...
create_pg_mesh_pattern P_top_two \
	-layers { \
		{ {horizontal_layer: M7} {width: 0.28} {spacing: interleaving} {pitch: 30} {offset: 0.856} {trim : true} } \
		{ {vertical_layer: M6}   {width: 0.28} {spacing: interleaving} {pitch: 30} {offset: 6.08}  {trim : true} } \
		} 
...
set_virtual_pad -net VSS -coordinate {96 -5} -layer M6
set_virtual_pad -net VDD -coordinate {192 -5} -layer M6
set_virtual_pad -net VSS -coordinate {288 -5} -layer M6
set_virtual_pad -net VDD -coordinate {384 -5} -layer M6
set_virtual_pad -net VSS -coordinate {485 -5} -layer M6

set_virtual_pad -net VSS -coordinate {-5 104} -layer M6
set_virtual_pad -net VDD -coordinate {-5 208} -layer M6
set_virtual_pad -net VSS -coordinate {-5 312} -layer M6
set_virtual_pad -net VDD -coordinate {-5 416} -layer M6
set_virtual_pad -net VSS -coordinate {-5 525} -layer M6

set_virtual_pad -net VDD -coordinate {485 104} -layer M6
set_virtual_pad -net VSS -coordinate {485 208} -layer M6
set_virtual_pad -net VDD -coordinate {485 312} -layer M6
set_virtual_pad -net VSS -coordinate {485 416} -layer M6
set_virtual_pad -net VDD -coordinate {485 525} -layer M6

set_virtual_pad -net VDD -coordinate {96 525} -layer M6
set_virtual_pad -net VSS -coordinate {192 525} -layer M6
set_virtual_pad -net VDD -coordinate {288 525} -layer M6
set_virtual_pad -net VSS -coordinate {384 525} -layer M6
